...
public class ThemeSwitcherBean {
	...
	public void init() {
		...
		// advancedThemes.add(new Theme("afterwork", "afterwork.png"));
		 advancedThemes.add(new Theme("aristo-rtl", "aristo.png"));
		// advancedThemes.add(new Theme("black-tie", "black-tie.png"));
		// advancedThemes.add(new Theme("blitzer", "blitzer.png"));
//		advancedThemes.add(new Theme("bluesky-rtl", "bluesky.png"));
		...
		// advancedThemes.add(new Theme("pepper-grinder",
		// "pepper-grinder.png"));
		advancedThemes.add(new Theme("redmond-rtl", "redmond.png"));
		...
		// themes.put("Afterwork", "afterwork");
		 themes.put("Aristo", "aristo-rtl");
		// themes.put("Black-Tie", "black-tie");
		// themes.put("Blitzer", "blitzer");
//		themes.put("Bluesky", "bluesky-rtl");
		...
		themes.put("Redmond", "redmond-rtl");
